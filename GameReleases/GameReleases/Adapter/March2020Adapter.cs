...
{
    class March2020Adapter : BaseAdapter<Game>
    {
        private MarchFragment marchFragment;
        private List<Game> games;
        public March2020Adapter(MarchFragment marchFragment, List<Game> games)
        {
            this.marchFragment = marchFragment;
            this.games = games;
        }
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null)
            {
                view = marchFragment.LayoutInflater.Inflate(Resource.Layout.game_row, null);
            }
